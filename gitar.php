...
<?php
if(isset($_POST['type']) && isset($_POST['strings']) && isset($_POST['girth']) && isset($_POST['tuning']) && isset($_POST['mod_guitar'])==false){
...
if(isset($_POST['mod_guitar']) && empty($_POST['mod_canceled'])){
      ...
      <?php while($row = mysqli_fetch_array($result)): ?>
        ...
        <tr>
          ...
          <td>
            ...
            <input type="hidden" name="guitar_type" value="<?php echo $row['name']?>">
            <input type="hidden" name="guitar_strings" value="<?php echo $row['strings']?>">
            <input type="hidden" name="guitar_girth" value="<?php echo $row['girth']?>">
            <input type="hidden" name="guitar_tuning" value="<?php echo $row['tuning']?>">
